export const aboutMe = [{
    profileImg: "./images/Profilepic1.jpg",
    intro: "Hi there! My name is Bianca and welcome to my learning journal.",
    blogFirstSection: 
        "After several months of learning in the Frontend Developer Career Path, I've made the big jump over to the Bootcamp to get expert code reviews of my Solo Projects projects and meet like-minded peers.",
    blogHeadingOne: "How I stay committed to learning",
    blogSecondSection: [
    ...
    blogHeadingTwo: "How I got started",
    blogThirdSection: [
